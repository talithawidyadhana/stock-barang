                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $ambilsemuadatadmin = mysqli_query($conn, "select * from login");
                                    $i = 1;
                                    while ($data = mysqli_fetch_array($ambilsemuadatadmin)) {
                                        $usrnm = $data['username'];
                                        $idu = $data['iduser'];
                                        $pw = $data ['password'];
                                            ?>
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="password" name="password"
                                                                class="form-control" value="<?=$pw;?>" placeholder="password">
                                                            <br>
                                        ...
                                        <div class="modal" id="delete<?=$idu;?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            Apakah anda yakin ingin menghapus <?=$usrnm;?>?
                                                            <input type="hidden" name="iduser" value="<?=$idu;?>">
                                                            <br>
                                                            <br>
                                                            <button type="submit" class="btn btn-danger"
                                                                name="hapusadmin">Yakin</button>
                                                        </div>
                                                    </form>
