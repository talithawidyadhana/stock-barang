...
<body class="sb-nav-fixed">
    ...
    <script>$(document).ready(function () { $('#datatablesSimple').DataTable({ dom: 'Bfrtip', buttons: [{ extend: 'pdf', title: 'Stock Barang', filename: 'stock_barang' }, { extend: 'excel', title: 'Stock Barang', filename: 'stock_barang' }, { extend: 'print', filename: 'stock_barang' }] }); });</script>
</body>
<!-- The Modal -->
